...
public class MeasurableTester {
    ...
    public static void main(String[] args) {
        ...
        Comparable[] countries1 = new Comparable[3];    //배열생성
        countries1[0] = new area( 176220);   //배열에 문자와 숫자입력
        countries1[1] = new area (513120);
        countries1[2] = new area( 30510);
    
        Arrays.sort(countries1); //오름차순 
        for(Comparable bcc: countries1) {
            System.out.println(bcc.getComparable() ); //오름차순으로 하나씩 출력
        }
