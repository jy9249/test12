...
public class TestServiceBoard {
    ...
    public static void setUpBeforeClass() throws Exception {
        ApplicationContext context = new ClassPathXmlApplicationContext("java26/springboard/ApplicationContext.xml");
    ...
    @Test
    public void test03_getBoardTotalRecord() {
        int result = service.getBoardTotalRecord("");
        assertEquals(result, 3);
    }

    @Test
    public void test04_getBoardList() {    
    ...
    @Test
    public void test05_getBoardSearch() {
    ...
    public void test28_getNextArticle() {
        ModelArticle result = service.getNextArticle(1, "free", "test");
        assertSame(result.getArticleno(), 2);
    }

    @Test
    public void test29_getPrevArticle() {
        ModelArticle result = service.getPrevArticle(2, "free", "test");
